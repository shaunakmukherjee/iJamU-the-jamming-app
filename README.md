...
- New users will be designated as __'new members'__ until users receives a certain number of endorements **Update UI diagram**
...
- User can filter jammers according to : 
     ...
     - skill (based on technical level/yrsExp/endorsements) **Update UI diagram**
     - Username and name
- User can send a request to **connect** to users found on searches
- User can accept/deny requests to connect
- User can delete users they are connected to **Update UI diagram**
...
- User can **endorse** and give ratings/comments to a connected user
     ...
     - Users can update their endorsements change ratings/comment **Update UI diagram**
...
Similar to technical rating.
**Yet to be discussed in more detail.**
